...
__export(index_exports, {
  ...
  QUOTE_ENGINE_CONFIG: () => QUOTE_ENGINE_CONFIG,
...
// src/angular/quote-engine.service.ts
var QUOTE_ENGINE_CONFIG = "QUOTE_ENGINE_CONFIG";
var QuoteEngineService = class _QuoteEngineService {
  constructor(config) {
  ...
  static create(config) {
    return new _QuoteEngineService(config);
  }
  // Getters
  get state() {
    return this._state;
  ...
  async generateQuote(customerData) {
    ...
    try {
      ...
      const quote = await this.client.generateQuote(data);
      this.updateState({
        quote,
        isLoading: false,
        currentStep: "preview"
   ...
   */
  async initPayment(type = "deposit", milestoneId, returnUrl) {
  ...
  addEventListener(event, handler) {
    return this.client.addEventListener(event, handler);
  }
  destroy() {
