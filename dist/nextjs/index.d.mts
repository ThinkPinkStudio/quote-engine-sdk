 ...
 */
interface QuoteEngineContextValue {
 ...
 * Provider props
 */
interface QuoteEngineProviderProps {
    /** SDK configuration */
 ...
 * ```
 */
declare function QuoteEngineProvider({ config, children, initialStep, customerData: initialCustomerData, onStateChange, }: QuoteEngineProviderProps): react_jsx_runtime.JSX.Element;
/**
 ...
 * ```
 */
declare function useQuoteEngineContext(): QuoteEngineContextValue;
...
}): string | number | boolean | Iterable<react.ReactNode> | react_jsx_runtime.JSX.Element | null;
/**
 ...
 * ```
 */
declare function useQuoteEngineConfig(overrides?: Partial<QuoteEngineConfig>): QuoteEngineConfig;
/**
 ...
 */
declare function validateApiKey(apiKey: string): Promise<boolean>;
/**
 * Server action to get quote by ID
 *
 * Fetches a quote from the server, useful for SSR pages.
 */
declare function getQuoteServer(quoteId: string): Promise<any>;

export { Analytics, type AnalyticsEvent, type AnalyticsEventType, type AnalyticsOptions, type ApiKeyEnvironment, type ApiKeyErrorCode, type ApiKeyPermissions, type ApiKeyScope, ApiKeyValidationError, type ApiResponse, type CallbackHandlers, type ChatCompletedPayload, type ChatMessage, type ChatMessageV2, type ChatResponse, type ChatSession, type ClassNameOverrides, ClientOnly, type Complexity, type ContractInfo, type ContractSignedPayload, type ConversationData, type Customer, type CustomerData, DEFAULT_DARK_THEME, type DeepPartial, type DepositInfo, type Discount, ELEGANT_THEME_DARK, ELEGANT_THEME_LIGHT, type EscrowInfo, type ExtractedRequirements, type Feature, GLASS_THEME_DARK, GLASS_THEME_LIGHT, type Language, MINIMAL_THEME_DARK, MINIMAL_THEME_LIGHT, type MessageMetadata, PLAN_LIMITS, PLAN_PRICING, type ParsedApiKey, type PaymentEventPayload, type PaymentInitResponse, type PaymentMethod, type PaymentMilestone, type PaymentStatus, type PriceBreakdown, type PriceCategory, type Pricing, type Project, type ProjectPhase, type ProjectType, type Quote, QuoteEngineClient, type QuoteEngineConfig, type QuoteEngineError, type QuoteEngineErrorCode, type QuoteEngineEvent, QuoteEngineProvider, type QuoteEventPayload, type QuoteGenerationResponse, type QuoteStatus, type QuoteStep, type QuoteV2, type RAGInsight, SCOPE_PERMISSIONS, type SimilarProjectRef, type StorageAdapter, type StreamEvent, type StreamEventType, THEME_STYLE_PRESETS, type Technology, type TenantPlan, type TenantPublicConfig, type TextLabels, type ThemeConfig, ThemeManager, type ThemeManagerOptions, type ThemeMode, type ThemeStyle, type Timeline, type Unsubscribe, VERSION, type VatInfo, WEBHOOK_ID_HEADER, WEBHOOK_SIGNATURE_HEADER, WEBHOOK_TIMESTAMP_HEADER, WebhookClient, type WebhookClientOptions, type WebhookEndpoint, type WebhookEvent, type WebhookEventType, type WebhookPayload, type WebhookPayloadBase, type WidgetMode, type WidgetOptions, type WidgetPosition, type WidgetState, assertPermission, calculatePricingSummary, computeSignature, constructEvent, createAnalytics, createAnalyticsFromConfig, createQuoteEngine, createStyledTheme, createThemeManager, createWebhookClient, debounce, deepMerge, formatCurrency, formatDate, formatQuoteNumber, generateThemeCss, getApiKeyPermissions, getCountryFromLocale, getDaysUntilExpiry, getLocaleFromLanguage, getQuoteServer, getScopeDescription, getThemePreset, hasPermission, isLiveKey, isQuoteExpired, isTestKey, isValidApiKeyFormat, isValidEmail, isValidPhone, listEnabledPermissions, maskApiKey, parseApiKey, storage, t, throttle, translations, useCustomerForm, usePayment, useQuote, useQuoteChat, useQuoteEngineConfig, useQuoteEngineContext, useQuoteEngineEvent, useQuoteWidget, validateApiKey, verifySignature };
