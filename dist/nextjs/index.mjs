...
var QuoteEngineContext = createContext(null);
function QuoteEngineProvider({
  ...
  return /* @__PURE__ */ jsx(QuoteEngineContext.Provider, { value, children });
}
...
function useQuoteChat() {
  ...
  const [ragInsight, setRagInsight] = useState2(null);
...
function usePayment() {
  ...
  const [escrowInfo, setEscrowInfo] = useState2(null);
  const quote = state.quote;
...
export {
  ...
  useQuoteEngineEvent,
  useQuoteWidget,
  validateApiKey2 as validateApiKey,
  verifySignature
};
