 ...
 * ```
 */
declare class QuoteEngineWidget {
    private client;
    private config;
    private options;
    private labels;
     ...
     */
    private announce;
    private showGenerateQuoteButton;
    private generateQuote;
    private renderQuotePreview;
    private handleError;
    private escapeHtml;
}
/**
 ...
 * ```
 */
declare function createWidget(config: QuoteEngineConfig & WidgetOptions): QuoteEngineWidget;
/**
