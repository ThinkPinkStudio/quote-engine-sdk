...
var QuoteEngine = (() => {
  ...
  __export(index_exports, {
    ...
    QuoteEngineWidget: () => QuoteEngineWidget,
  ...
  var QuoteEngineWidget = class {
    ...
    render() {
      ...
      this.elements.chatContainer = this.elements.root.querySelector(".qe-chat");
      this.elements.messagesContainer = this.elements.root.querySelector(".qe-messages");
      this.elements.inputContainer = this.elements.root.querySelector(".qe-input-container");
      this.elements.input = this.elements.root.querySelector(".qe-input");
      this.elements.sendButton = this.elements.root.querySelector(".qe-send-btn");
    ...
    renderMessages() {
      ...
      const cl = this.cls;
      this.elements.messagesContainer.innerHTML = messages.map(
        (msg) => {
          const roleClass = msg.role === "user" ? this.c("qe-message-user", cl.messageUser) : this.c("qe-message-assistant", cl.messageAssistant);
          return `
    ...
    renderQuotePreview() {
      ...
      const previewEl = this.elements.root.querySelector(".qe-quote-preview");
      const chatEl = this.elements.root.querySelector(".qe-chat");
      if (previewEl && chatEl) {
