 ...
 */
declare const QuoteEngineKey: InjectionKey<ReturnType<typeof createQuoteEngineComposable>>;
/**
 ...
 * ```
 */
declare function createQuoteEngineComposable(config: QuoteEngineConfig): {
        ...
        chatSession: {
            ...
            messages: {
                ...
                metadata?: {
                    ...
                    shouldGenerateQuote?: boolean | undefined;
        ...
        quote: {
            ...
            pricing: {
                ...
                milestones: {
                    ...
                    amount: number;
                    description: string;
                    dueCondition?: string | undefined;
                    status?: "pending" | "paid" | "released" | undefined;
                }[];
            };
            escrow?: {
                status: "none" | "pending" | "held" | "partial_release" | "released" | "disputed" | "refunded";
    ...
    streamingContent: vue.Ref<string, string>;
    messages: vue.ComputedRef<{
        id: string;
        role: "user" | "assistant" | "system";
        content: string;
        timestamp: Date;
    ...
    shouldGenerateQuote: vue.ComputedRef<boolean>;
    startChat: (customerData?: CustomerData) => Promise<ChatSession>;
 ...
 * ```
 */
declare function useQuoteEngine(): {
    client: QuoteEngineClient;
    state: {
        currentStep: QuoteStep;
        isOpen: boolean;
...
declare function usePayment(): {
    isProcessing: vue.Ref<boolean, boolean>;
    paymentError: vue.Ref<{
        code: QuoteEngineErrorCode;
        message: string;
        details?: Record<string, unknown> | undefined;
        cause?: Error | undefined;
    } | null, QuoteEngineError | {
        code: QuoteEngineErrorCode;
        message: string;
        details?: Record<string, unknown> | undefined;
        cause?: Error | undefined;
    } | null>;
    clientSecret: vue.Ref<string | null, string | null>;
    paymentIntentId: vue.Ref<string | null, string | null>;
    escrowInfo: vue.Ref<{
        totalPaid: number;
        platformFee: number;
        totalHeld: number;
...
declare function useQuoteWidget(): {
    ...
    isLoading: vue.ComputedRef<boolean>;
    currentStep: vue.ComputedRef<QuoteStep>;
    error: vue.ComputedRef<{
        code: QuoteEngineErrorCode;
        message: string;
        details?: Record<string, unknown> | undefined;
